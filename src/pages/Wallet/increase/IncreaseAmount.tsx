        ...
        <div dir="rtl" className="px-3 text-[15px]">
          ...
          <form action="" method="post" className="r relative">
            ...
            <input
              ...
              className="my-3 h-8 w-full flex items-center text-center py-1 jus justify-center font-iran-medium"
            />
          </form>

          <div className="mt-8 flex flex-row flex-wrap gap-7 items-center justify-between w-[87%] mx-auto">
